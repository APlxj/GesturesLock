...
public class LockPatternViewEx extends View {
    ...
    public LockPatternViewEx(Context context, AttributeSet attrs) {
        ...
        mRegularColor = getResources().getColor(Resources.resolveAttribute(getContext(),
                R.attr.color_lock_pattern_view_regular));
        mErrorColor = getResources().getColor(Resources.resolveAttribute(getContext(),
                R.attr.color_lock_pattern_view_error));
        mSuccessColor = getResources().getColor(Resources.resolveAttribute(getContext(),
                R.attr.color_lock_pattern_view_success));

        mRegularColor = a.getColor(R.styleable.LockPatternViewEx_regularColor, mRegularColor);
        mErrorColor = a.getColor(R.styleable.LockPatternViewEx_errorColor, mErrorColor);
        mSuccessColor = a.getColor(R.styleable.LockPatternViewEx_successColor, mSuccessColor);

        int pathColor = a.getColor(R.styleable.LockPatternViewEx_pathColor, mRegularColor);
